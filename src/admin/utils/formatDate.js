 ...
 *
 * NOTE: this file was previously saved on disk as "formateDate.js" (typo),
 * which silently broke IncidentTable.jsx's and StatusHistoryTimeline.jsx's
 * `import ... from "../utils/formatDate"` — dead code until Phase 3 wired
 * those components up. Renamed to match every existing import site instead
 * of touching multiple consumers.
 *
