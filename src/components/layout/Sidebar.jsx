 ...
 * ✓ Logout now goes through useAuth().logout() instead of calling
 *   authHelpers.logout() directly, so AuthContext state stays in sync
 * ✓ TAG/EMOJI incident-type maps now imported from constants/incidentTypes.js
 *   instead of being duplicated locally (see that file for why)
 *
