 ...
 * ✓ Live user now comes from AuthContext instead of reading localStorage
 *   directly via authHelpers (that read never worked because Login never
 *   wrote to it — see AuthContext.jsx)
 * ✓ dark:bg-na-navygit typo fixed -> dark:bg-na-navy (Dashboard had no
 *   dark-mode background at all before this)
 *
...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] overflow-hidden bg-white dark:bg-na-navy">
